...
public class AudioReactiveGimbal : MonoBehaviour
{
    // FFT fields
    ...
    private int _xDirection, _yDirection, _zDirection, _rotationDirection;
    ...
    void UpdateGimbalOrientation()
    {
        ...
        gameObject.transform.RotateAround(position, transform.up, Time.deltaTime + _fftOut[5]);
    }
}